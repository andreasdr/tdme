 ...
 * @version $Id$
 */
public final class GUISelectBoxMultiple extends GUIElement  {

	private static final String NAME = "selectbox-multiple";
	 ...
	 * Constructor
	 */
	public GUISelectBoxMultiple() throws IOException {
		attributes = new HashMap<String, String>();
		template = FileSystem.getInstance().getContent("resources/gui/definitions/elements", "selectbox-multiple.xml");
	}
