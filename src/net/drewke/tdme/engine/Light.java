...
public final class Light {
	 ...
	 * @param id
	 */
	public Light(GLRenderer renderer, int id) {
	...
	public void update() {
		if (enabled) {
			...
			renderer.setLightPosition(id, renderer.getCameraMatrix().multiply(position, lightPositionTransformed).scale(1f / lightPositionTransformed.getW()).getArray());
